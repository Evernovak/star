...
<div class="container">
	<div class="col-xs-12 corpo-container">
		<div class="col-xs-12 col-sm-6 form-upload">
			<?php echo form_open_multipart(base_url('admin/foto/uploadFoto'));?>
			...
			<div class="col-xs-12 col-sm-4 fotos">
				<div class="thumbnail">
					...
					<div class="caption">
						...
						<?php echo form_open_multipart(base_url('admin/foto/deleteFoto'));?>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <?php echo form_open_multipart(base_url('admin/foto/updateFoto'));?>
